...
const BudgetRules = () => {
  ...
  return (
    <div
      className={`bg-green-300 border-4 border-black w-full sm:w-2/3 flex flex-col items-center gap-4 p-4 justify-center `}
    >
          ...
          {stage === Stage.TV_INTERNET && (
            <div className="p-4">
              ...
              <div className="col-span-2 col-start-0">
                {" "}
                You can purchase TV/Internet service; however, it is NOT
                required.
              </div>
            </div>
          )}
          {stage === Stage.PHONE && (
            <div className="p-4">
              ...
              <ul className="list-disc">
                ...
                <li>
                  It is not necessary for children to have phones, but you may
                  buy one for your children if you choose to do so.
                </li>
              </ul>
            </div>
          )}
          {stage === Stage.GROCERIES && (
            <div className="p-4">
              ...
              <div className="col-span-2 col-start-0">
                ...
                />
                Use the chart to determine how much food will cost for each
