...
const TotalExpensesTable = ({
    ...
    return (
        ...
        <div>
            <p className="font-bold">Section 6: Total Expenses</p>
            <p className="pb-1">Add up your expenses in this section and put the total in Box R.</p>
            <div className="pb-1">
            <table className="shadow-md">
                <thead>
                    <tr>
                        <th className="border border-black bg-green-300 w-60">Expense</th>
                        <th className="border border-black bg-green-300 w-60">Cost per Month</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td className="border border-black bg-white pl-1"> Total Housing Costs</td>
                        <td className="border border-black bg-white pl-1">H. 
                            <input 
                    ...
                    <tr>
                        <td className="border border-black bg-white pl-1">Total Car Costs</td>
                        <td className="border border-black bg-white pl-1">M. 
                            <input
                    ...
                    <tr>
                        <td className="border border-black bg-white pl-1"> Total Additional Costs</td>
                        <td className="border border-black bg-white pl-1">Q. 
                            <input
                    ...
                    <tr>
                        <td className="border border-black bg-green-300 pl-1 font-semibold">Total Expenses</td>
                        <td className="border border-black bg-white pl-1">R. 
                            <input
                                value = {totalExpenses} 
                                onChange = {(e) => {
