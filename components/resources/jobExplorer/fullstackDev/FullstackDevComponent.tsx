...
import { additionalSkills, description, mandatorySkills, project, title } from "../../../../pages/api/resources/jobExplorer/fullstackDev/data";

const FullstackDevComponent = () => {
  return (
...
export default FullstackDevComponent;
