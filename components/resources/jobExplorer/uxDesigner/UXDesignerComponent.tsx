...
import { additionalSkills, description, mandatorySkills, project, title } from "../../../../pages/api/resources/jobExplorer/uxDesigner/data";

const UXDesignerComponent = () => {
  return (
...
export default UXDesignerComponent;
