...
import { additionalSkills, description, mandatorySkills, project, title } from "../../../../pages/api/resources/jobExplorer/devOpsEngineer/data";

const DevOpsEngineerComponent = () => {
  return (
