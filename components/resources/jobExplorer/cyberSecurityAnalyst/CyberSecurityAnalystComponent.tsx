...
import { additionalSkills, description, mandatorySkills, project, title } from "../../../../pages/api/resources/jobExplorer/cyberSecurityAnalyst/data";

const CyberSecurityAnalystComponent = () => {
  return (
...
export default CyberSecurityAnalystComponent;
