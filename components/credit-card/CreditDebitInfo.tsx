                        ...
                        <div className="flex md:flex-row flex-col-reverse justify-center">
                            <div className="flex flex-col justify-center bg-purple-200 p-12 mx-12 rounded-2xl">
                                ...
                                <span className="text-2xl">
                                    Allow consumers to <DropDownMenu key={borrowArray[0]} words={borrowArray} />
                                    money from a financial institution and <DropDownMenu key={payArray[0]} words={payArray} />
                                    it back later
                                </span>
                            </div>
                    ...
                    <div className="w-full p-12">
                        <div className="flex md:flex-row-reverse flex-col-reverse justify-center">
                            <div className="flex flex-col justify-center bg-green-200 p-12 mx-12 rounded-2xl">
                                ...
                                <span className="text-2xl">
                                    Allow consumers to <DropDownMenu key={spendArray[0]} words={spendArray} /> money they have <DropDownMenu key={depositArray[0]} words={depositArray} /> in their bank account
                                </span>
                            </div>
            ...
            <div className="flex md:flex-row-reverse flex-col justify-center px-12">
                ...
                <div className=" flex flex-col justify-center bg-gray-200 p-12 mx-12 rounded-2xl">
                    ...
                    <ul className="flex flex-col gap-4 text-2xl">
                        <li>Allow a person to make <DropDownMenu key={purchaseArray[0]} words={purchaseArray} /></li>
                        <li>If card is <DropDownMenu key={lostArray[0]} words={lostArray} /> or <DropDownMenu key={stolenArray[0]} words={stolenArray} />, report import it immediately</li>
                        <li>Hard, <DropDownMenu key={plasticArray[0]} words={plasticArray} /> card with information stored on a <DropDownMenu key={magneticArray[0]} words={magneticArray} /> strip.</li>
                        <li>Owner's <DropDownMenu key={nameArray[0]} words={nameArray} /> and an <DropDownMenu key={expirationArray[0]} words={expirationArray} /> date on the card</li>
                    </ul>
                </div>
            </div>
        </div>
