  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex flex-col gap-8 w-full">
        <div id="hero" className="flex flex-col sm:flex-row bg-gray-800 shadow-lg p-4 gap-8 pb-16">
          <div className="flex flex-col w-full sm:w-1/2 gap-8 sm:p-16">
            <h1 className="text-5xl text-white">Math Champ helps parents motivate their children</h1>
            <div className="flex flex-col sm:flex-row gap-4">
              <h2 className="text-2xl text-white flex-1 pr-4">Have your child take a <b>FREE</b> diagnostic to see where they stand</h2>
              <Link href="/diagnostic">
                  <button className="flex-shrink text-white text-xl from-blue-500 via-blue-500 to-blue-500 border-blue-900 hover:from-blue-400 bg-gradient-to-b px-8 py-4 font-bold border-b-4 rounded-xl active:border-b-2">
                    Take the First Step
                  </button>
                </Link>
            </div>
        ...
        <div id="banner" className="bg-blue-500 heropattern-architect-blue-400 shadow-lg flex-col text-center p-8">
        ...
        <div id="steps" className="grid grid-cols-1 md:grid-cols-3 gap-4 justify-between">
          ...
          <div id="step3" className="bg-white rounded-lg p-8 shadow-lg">
            {/* <p className="font-bold"></p> */}
            <p className="font-bold text-xl">Step 3: Get Your Personalized Reports</p>
            <p>
              Your customized Math Champ report will give you weekly insights and
              the supplemental resources you need for your child.
            </p>
            <div className="flex flex-col justify-center items-center bg-white p-8">
              <div className="sm:w-3/4 items-center">
                <img src="/diagnostic/diagnostic-sample-report.gif" className="sm:rounded-r-lg rounded-tr-lg"/>
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-col pt-1 bg-gray-800">
