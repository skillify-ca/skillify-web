 ...
 */
 export const HarriButton: React.FC<ButtonProps> = ({ backgroundColor, textColor, label, onClick, ...props }) => {
    ...
    return (
		<button
			type="button"
			onClick={onClick}
			className={`bg-gradient-to-b px-4 py-2 font-thin border-b-4 rounded-sm active:border-b-2 ${backgroundStyles}`}
			{...props}
		>
