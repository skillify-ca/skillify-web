...
export const TopicItem: React.FC<TopicItemProps> = ({
	...
	switch (accessory) {
		case 'rating':
			...
			break;
		case 'completed':
			accessoryComponent = <img src={'images/checkmark.png'} alt="skill image" className="w-8" />;
			break;
		case 'progress':
			accessoryComponent = <img src={'images/progress.png'} alt="skill image" className="w-8" />;
			break;
	}
	return (
		<div className="w-72">
			...
			>
				<div className="w-8 h-8 bg-purple-100 rounded-full p-1 ring-2 ring-blue-300">
					{disabled ? <img src="/images/skills/lock.png" alt="" /> : image && <img src={image} alt="" />}
				</div>
