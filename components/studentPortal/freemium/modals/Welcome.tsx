...
export default function Welcome() {
  return (
    <div className="md:space-y-10 space-y-2">
      <h1 className="md:text-3xl text-lg font-bold text-center mt-10 md:mt-0">
        Welcome to Skillify Coding Academy!
      </h1>
      <div className="flex flex-col md:flex-row h-80 md:h-full items-center">
        <div className="flex flex-col space-y-4 md:space-y-8 text-sm md:text-base bg-mewtwo p-6 rounded-lg md:mt-0 mt-4">
          <p>
          ...
          <p>
            ...
            assignment and get personalized feedback from a Skillify coaches.
          </p>
        </div>
        <img
