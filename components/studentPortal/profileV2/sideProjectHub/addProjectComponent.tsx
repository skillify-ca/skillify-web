...
export default function AddProjectComponent() {
  ...
  return (
    <div className="p-4 flex flex-col">
      ...
      <h3 className="mt-4 mb-2 text-xl font-bold">GitHub Link</h3>
      <Input
        value={githubLink}
      ...
      <h3 className="mt-4 mb-2 text-xl font-bold">Project Link</h3>
      <Input
        value={projectLink}
      ...
      <h3 className="mt-4 mb-2 text-xl font-bold">Image</h3>
