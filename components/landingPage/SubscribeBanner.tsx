    ...
    <div className="w-full ">
      <div className="flex flex-col items-center justify-center p-4 text-xl lg:m-8 md:p-8 lg:rounded-md bg-murkrow">
        <p className="mb-4 text-center -xl max-w-7xl text-charmander">
          Universities and Colleges require multiple years of your life and
          treat you like a number. Traditional Coding Bootcamps sell you on
          unrealistic timelines then leave you unprepared for finding a job.
        </p>
