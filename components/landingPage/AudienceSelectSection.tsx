    ...
    return (
        <div id="stage" className="flex flex-col items-center justify-center w-full p-8 sm:p-16 bg-murkrow">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-4xl">
                ...
                {/* K-12 / Parents */}
                <a href="/tutoring" className="flex flex-col h-full p-6 bg-white border-t-8 shadow-xl rounded-xl border-charmander hover:scale-105 transition-transform cursor-pointer no-underline">
                ...
                <a href="/career" className="flex flex-col h-full p-6 bg-white border-t-8 shadow-xl rounded-xl border-rattata hover:scale-105 transition-transform cursor-pointer no-underline">
                    <p className="text-3xl mb-3">🎓</p>
                ...
                <a href="/tech" className="flex flex-col h-full p-6 bg-white border-t-8 shadow-xl rounded-xl border-pikachu-500 hover:scale-105 transition-transform cursor-pointer no-underline">
                    <p className="text-3xl mb-3">💻</p>
                ...
                {/* Schools / Admins */}
                <a href="/schools" className="flex flex-col h-full p-6 bg-white border-t-8 shadow-xl rounded-xl border-murkrow hover:scale-105 transition-transform cursor-pointer no-underline">
                    <p className="text-3xl mb-3">🏫</p>
