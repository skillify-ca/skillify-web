...
const TestimonialSect = () => {
  const testimonialData = [
    {
      ...
      text: "Skillify helped me understand the fundamentals of frameworks and eng team development. As a product manager in tech, I now have a better understanding of the development process and needs of my team members! Working on a capstone project helped me walk a mile in the shoes of some of my teammates!",
  ...
  return (
    <div>
      <div className="flex flex-col justify-center p-4 bg-slate-100 sm:p-8">
        <div className="">
