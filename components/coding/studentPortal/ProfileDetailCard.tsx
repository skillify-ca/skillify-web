  ...
  return (
    <div className="grid grid-cols-4 h-full w-full text-sm border-2 bg-slate-50 text-slate-800 border-slate-800 hover:bg-violet-100">
      <div className="flex ml-3 place-items-center col-span-4 mt-4">
        <img
          className="col-span-1 w-1/5 my-3 border-3 rounded-full border-slate-800 "
          src={avatar}
        />
      ...
      <div className="ml-4 col-span-4 p-1 mb-4">
        ...
        <div className="flex items-center p-2 ">
          <img
            ...
            className="col-span-1 items-center w-1/6 mr-5 rounded-full"
          />
        ...
        <div className="flex items-center p-2">
          <div className="mr-5">
            <div className="bg-slate-800 w-16 h-16 border-black rounded-full flex items-center justify-center">
