...
const DiceSection: FC = () => {
  ...
  return (
    <div className="flex items-center justify-evenly">
      <div className="flex flex-col items-center justify-center w-40 h-40 gap-3 border-2 -z-10 rounded-3xl bg-neutral-300 text-black-500 drop-shadow-md">
      ...
      <div className="flex flex-col items-center gap-5">
        <div className="flex -z-10 flex-col justify-center text-center text-black-500 bg-[#ABC0CF] rounded-md p-5 gap-2 drop-shadow-xl">
          <p>Your Number:</p>
