...
import { generateQuestionForSkill } from "./api/questions/questionGenerator";
...
const Diagnostic = () => {
  ...
  const [questionsLeftInUnit, setQuestionsLeftInUnit] =
    useState<number>(QUESTIONS_PER_UNIT);
