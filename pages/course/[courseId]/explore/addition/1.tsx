      ...
      <div className="grid grid-cols-1 bg-white p-8 m-8 space-y-4">
        ...
        <div className="grid grid-cols-1 bg-white space-y-4">
          <div className="flex flex-col space-y-4">
            ...
            <img src="/images/math1/addition/2/addition_1.png" className="" />
            ...
            <img src="/images/math1/addition/2/addition_2.png" className="" />

            <p>Let’s try another one! What is 1253 + 1667?</p>
            <img src="/images/math1/addition/2/addition_3.png" className="" />
            ...
            <img src="/images/math1/addition/2/addition_4.png" className="" />
            <img src="/images/math1/addition/2/addition_5.png" className="" />

            <p>
              The same concept applies to 5 and 6 digit addition as well. Let’s
              try it out with some practical questions!
            </p>
            <img src="/images/math1/addition/2/addition_6.png" className="" />
            ...
            <img src="/images/math1/addition/2/addition_7.png" className="" />
            ...
            <img src="/images/math1/addition/2/addition_8.png" className="" />

            <p>
              Melissa had $3,900 in her bank account. She deposited another
              $1,500. How much money does Melissa have in her account now?
            </p>
            <img src="/images/math1/addition/2/addition_9.png" className="" />
            <img src="/images/math1/addition/2/addition_10.png" className="" />
            <p>Who is right?</p>
            <p>
