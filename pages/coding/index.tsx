...
export default function Coding(props) {
  ...
  return (
    <div className=" bg-white">
      <div className="bg-blue-600 p-4 text-center font-bold text-white">CS Champ</div>
      <div className="p-4 flex flex-col space-y-4">
        <HeroHome />
        <p className="text-center font-bold text-xl">Interactive Lessons</p>
        <div className="flex space-x-8 justify-center pb-16">
        ...
        <div className="flex flex-col space-y-8 bg-blue-600 py-16">
          ...
          <div className="flex justify-center">
            <a className="btn p-4 rounded-md text-blue-800 bg-white hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0">Learn More</a>
          </div>
        </div>
      </div>
    </div>
