        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 w-full">
          <div className="p-8 lg:p-16 flex flex-col justify-center md:text-center lg:text-left">
            ...
            <p className="text-sm uppercase tracking-widest text-charmander font-semibold mb-4">
              K-12 Tutoring · Math · Coding · Science · English
            </p>
            ...
            <p className="my-4 text-base text-gray-500 sm:text-lg md:text-xl max-w-xl">
              Every student deserves a great teacher and personalized attention. Skillify helps your child build confidence, and teaches the
              material a way that is engaging and sticks.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-2">
              ...
              <a
                href="mailto:vithushan19@gmail.com?subject=Free intro call for K-12 tutoring"
