  ...
  const [sections, setSections] = useState([
    {
      ...
      prompts: [
        {
          text:
            "As a Data Analyst at our tech company, you're working with a large dataset. How would you approach cleaning and preprocessing the data to ensure its accuracy and reliability?",
          answer: "",
          exemplaryAnswer:
    ...
    },
    {
      ...
      prompts: [
        {
          text:
            "As a Web Developer, you're tasked with improving website performance. How would you optimize the loading speed of our web pages to enhance user experience?",
          answer: "",
          exemplaryAnswer:
    ...
    },
    {
      ...
      prompts: [
        {
          text:
            "As a Mobile App Developer, you're building a new app feature. How would you ensure the feature is both user-friendly and performs well on different devices?",
          answer: "",
          exemplaryAnswer:
