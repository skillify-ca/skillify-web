...
const nbaDataPlayground = ({ lessonComponents }) => {
  ...
  const fantasyProjectionDataURL = `https://api.sportsdata.io/api/nba/fantasy/json/PlayerSeasonProjectionStats/2024?key=${process.env.NEXT_PUBLIC_NBA_DATA_API_KEY}`;
  ...
  return (
    <>
      <div className="col-span-7">
        <div className="grid h-full grid-cols-1 p-8 space-y-20 text-gray-700 bg-gray-100 place-items-center">
