...
const DictionaryContent = () => {
  ...
  return (
    <div>
      ...
      {/* Navigation Bar */}
      <div className="w-1/4 p-2 px-4 mb-2 text-lg font-bold text-gray-800 bg-gray-200">
        List of Jobs
        <svg
      ...
      <div className="flex flex-row">
        {sidebarVisible && (
          <div className="w-1/4 h-screen px-4 overflow-y-auto">
            {jobTerms.map((job) => (
              <div
                key={job.term}
            ...
            {selectedTerm && (
              <div className="mb-2">
                ...
                {selectedPros.length > 0 && (
                  <div className="p-2 my-2 bg-green-100">
                    <h3 className="font-bold text-md">Pros</h3>
                    <ul>
                ...
                {selectedCons.length > 0 && (
                  <div className="p-2 my-2 bg-red-100">
                    <h3 className="font-bold text-md">Cons</h3>
                    <ul>
          ...
          {jobTerms.map((job) => (
            <div key={job.term} id={job.term} className="mb-6">
              <div className="p-4 mb-6 bg-gray-100 border border-gray-300 rounded-lg">
                <h2 className="mt-2 text-xl font-bold">{job.term}</h2>
                {job.sections.map((section) => (
                  <div key={section.title}>
                    <h3 className="mt-2 text-lg font-bold cursor-pointer hover:text-blue-500">
                      <span
                        onClick={() =>
                          handleTermClick(
                            section.title,
