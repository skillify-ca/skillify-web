...
function DungeonsAndDragonsCharacterSheet() {
  const levelDescriptions = [
    ...
    },
    {
      5: (
        <p>
          5. Implement skills. See `SKILL_LIST` for the list of all skills and
    ...
    },
    {
      6: (
        <p>
          6. Save the character(s) to an API so they can be retrieved when the
          app starts next time. - Make a post request with a JSON payload to
          %POST URL% to save data, and a get request to %GET URL% to retrieve
          the data. It will accept any valid JSON blob and return the most
          recent version - for example, if your github username is vithushan19,
          you would use %URL% (include the curly braces) - you must include a
    ...
    },
    {
      7: (
        <p>
          7. Implement a maximum on all attributes of 70. For example, if a
    ...
    },
    {
      8: (
        <p>
          8. Add the ability to edit multiple characters simultaneously with the
          same rules above
        </p>
      ),
    },
    {
      9: (
        <p>
          9. Add a Skill Check section for each character. This represents a
    ...
    },
    {
      10: (
        <p>
          10. Add a party skill check section. This is the same as the above,
          except we should use the character with the highest skill total to
          attempt the action - Show which character was selected to attempt the
          action
        </p>
      ),
    },
