...
export async function getServerSideProps({ params }) {
  const resources: Resource[] = [
    {
      ...
      link:
        "https://docs.google.com/forms/d/e/1FAIpQLSc9uMgy9iVG9cXnXiZTl9yGbAfg26LCTXofqLc8BoBY_FBMmQ/viewform?usp=sf_link",
  ...
  const lessonComponents: LessonComponentData[] = [
    ...
    },
    {
      ...
      text:
        "This summary for JavaScript contains additional coding challenges to apply your knowledge. Fill out the form below again. What concepts do you feel improved the most? Which concepts do you feel weaker around? Review those lessons and cheatsheets in Codecademy then try to complete these challenges.",
    },
    {
