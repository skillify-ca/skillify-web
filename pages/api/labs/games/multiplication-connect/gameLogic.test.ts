import { SelectedBy, createGrid, calculateWinner } from "./gameLogic";
...
describe("calculateWinner() Tests", () => {
  ...
  test("PlayerOne horizontal win", () => {
    ...
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERONE (horizontal) Four in a row!"
    );
  });
  test("PlayerTwo horizontal win", () => {
    ...
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERTWO (horizontal) Four in a row!"
    );
  });
  ...
  test("PlayerOne vertical win", () => {
    ...
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERONE (vertical) Four in a row!"
    );
  });
  test("PlayerTwo vertical win", () => {
    ...
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERTWO (vertical) Four in a row!"
    );
  });
  ...
  test("PlayerOne descending diagonal win", () => {
    ...
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERONE (descending diagonal) Four in a row!"
    );
  });
  test("PlayerTwo descending diagonal win", () => {
    ...
    grid[19].selectedBy = SelectedBy.PlayerTwo;
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERTWO (descending diagonal) Four in a row!"
    );
  });
  ...
  test("PlayerOne ascending diagonal win", () => {
    ...
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERONE (ascending diagonal) Four in a row!"
    );
  });
  test("PlayerTwo ascending diagonal win", () => {
    ...
    expect(calculateWinner(grid, isPlayerOne)).toEqual(
      "PLAYERTWO (ascending diagonal) Four in a row!"
    );
  });
