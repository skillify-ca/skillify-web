export enum QuestionType {
  ...
  PATTERN_COUNT_BLANKS_PROBLEM = "pattern count blanks", // rename
  VERTICAL_DIGITS_TO_NUM = "vertical digits to num", // rename
  NUM_TO_VERITCAL_DIGITS = "num to vertical digits", // rename
  WORD_TO_HORIZONTAL_DIGITS = "word to horizantal digits", //rename
  ARRAY_QUESTION = "array question",
  MULTIPLICATION_EQUAL_GROUPS = "equal groups",
  MULTIPLE_CHOICE_WORD = "multiple choice word", // Addition Property with words as mc options
  ...
  FINANCE_BUDGET_TABLE_PROBLEM = "yes/no under budget problem",
  FINANCE_TIP_PROBLEM = "tip amount based on tip percentage",
  FINANCE_BALANCE_BUDGET_PROBLEM = "income vs expenses problem",
}
