...
export const getFourthGradeQuestion = () => {
  ...
  const fourthGradeQuestions = fourthGradeSkills.map((skill) =>
...
export const getFifthGradeQuestion = () => {
  ...
  const fifthGradeQuestions = fifthGradeSkills.map((skill) =>
    generateQuestionForSkill(skill)
  );
...
export const getSixthGradeQuestion = () => {
  ...
  const sixthGradeQuestions = sixthGradeSkills.map((skill) =>
    generateQuestionForSkill(skill)
  );
