                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 w-full">
                    <div className="p-8 lg:p-16 flex flex-col justify-center md:text-center lg:text-left">
                        ...
                        <p className="text-sm uppercase tracking-widest text-charmander font-semibold mb-4">
                            Coding Workshops · AI Education and Ethics · School Board Advisory
                        </p>

                        <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                            Bring a real software engineer{" "}
                        ...
                        <p className="my-4 text-base text-gray-500 sm:text-lg md:text-xl max-w-xl">
                            Curriculum-aligned coding and technology workshops for grades 3 to 12,
                            facilitated by an engineer who has shipped real products used by
                            millions of people. Available onsite or online across the GTA.
                        </p>
                  ...
                  bg-white hover:bg-gray-50 active:border-b-2 cursor-pointer text-gray-700 text-center"
                        ...
                        <div className="flex items-start gap-2 mt-6 max-w-sm">
                            ...
                            <p className="text-sm text-gray-500">
                                All workshops are{" "}
                                <span className="font-semibold text-gray-700">curriculum-aligned</span>
                                {" "}and require no prior setup or technical knowledge from the teacher.
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        <img
                            ...
                            alt="Skillify classroom workshop"
                        />
                    </div>
                </div>
            </div>
